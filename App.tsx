...
import { StatusBar, StyleSheet, Text, View, TouchableOpacity, useColorScheme, Alert } from 'react-native';
...
function App() {
  ...
  return (
    <View style={[styles.container, backgroundStyle]}>
      ...
      {/* Header */}
      <Text style={[styles.titleText, textStyle]}>SurStudio</Text>
      <Text style={[styles.subtitleText, textStyle]}>Real-time Pitch Detection</Text>
      <Text style={[styles.demoText, textStyle]}>🎵 Live Audio Processing</Text>
      ...
      <View style={styles.statusContainer}>
        <Text style={[styles.statusText, textStyle]}>
          Status: {!hasPermission ? 'No microphone permission' : isRecording ? 'Recording...' : 'Ready to record'}
        </Text>
